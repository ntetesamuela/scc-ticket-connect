...
// @updateURL    https://github.com/ntetesamuela/scc-ticket-connect/raw/refs/heads/main/HOU6%20SCC%20Ticket%20Connect-3.2.user.js
// @downloadURL  https://github.com/ntetesamuela/scc-ticket-connect/raw/refs/heads/main/HOU6%20SCC%20Ticket%20Connect-3.2.user.js
...
(function () {
    ...
    // ─── INIT ─────────────────────────────────────────────────────
    console.log('[SCC Ticket Connect] Starting v3.5...');
    fetchAllChannels();
    startObserver();
